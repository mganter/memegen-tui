...
// Entry is one row in the browser: a parent link, sub-directory, or image file.
type Entry struct {
...
// Load reads dir and builds the filtered, ordered entry list: parent ("..")
// first, then sub-directories, then image files, each group alphabetical.
